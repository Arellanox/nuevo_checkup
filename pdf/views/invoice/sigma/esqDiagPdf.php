            ...
            <tr>
                <td colspan="3" rowspan="1" style="text-align: center;">
                    ...
                    <div style="position: relative; text-align: left; display: inline-block; margin-left: 0;">
                        ...
                        <!-- Frontal -->
                        <span style="position: absolute; top: 7%; left: 18%; color: red; font-weight: bold; background-color: aqua;">
                            <?php
                        ...
                        <span style="position: absolute; top: 11%; left: 18%; color: red; font-weight: bold; background-color: aqua;">
                            <?php
                        ...
                        <span style="position: absolute; top: 13%; left: 5%; color: red; font-weight: bold; background-color: aqua;">
                            <?php
                        ...
                        <span style="position: absolute; top: 13%; left: 25%; color: red; font-weight: bold; background-color: aqua;">
                            <?php
                        ...
                        <span style="position: absolute; top: 15%; left: 18%; color: green; font-weight: bold; background-color: aqua;">
                            <?php
                        ...
                        <span style="position: absolute; top: 19%; left: 18%; color: green; font-weight: bold; background-color: aqua;">
                            <?php
                        ...
                        <span style="position: absolute; top: 25%; left: 18%; color: green; font-weight: bold; background-color: aqua;">
                            <?php
                        ...
                        <span style="position: absolute; top: 32%; left: 18%; color: green; font-weight: bold; background-color: aqua;">
                            <?php
                        ...
                        <span style="position: absolute; top: 20%; left: 5%; color: blue; font-weight: bold; background-color: aqua;">
                            <?php
                        ...
                        <span style="position: absolute; top: 20%; left: 30%; color: blue; font-weight: bold; background-color: aqua;">
                            <?php
                        ...
                        <span style="position: absolute; top: 28%; left: 5%; color: blue; font-weight: bold; background-color: aqua;">
                            <?php
                        ...
                        <span style="position: absolute; top: 28%; left: 30%; color: blue; font-weight: bold; background-color: aqua;">
                            <?php
                        ...
                        <span style="position: absolute; top: 35%; left: 5%; color: blue; font-weight: bold; background-color: aqua;">
                            <?php
                        ...
                        <span style="position: absolute; top: 35%; left: 30%; color: blue; font-weight: bold; background-color: aqua;">
                            <?php
                        ...
                        <span style="position: absolute; top: 39%; left: 7%; color: green; font-weight: bold; background-color: aqua;">
                            <?php
                        ...
                        <span style="position: absolute; top: 39%; left: 23%; color: green; font-weight: bold; background-color: aqua;">
                            <?php
                        ...
                        <span style="position: absolute; top: 45%; left: 5%; color: green; font-weight: bold; background-color: aqua;">
                            <?php
                        ...
                        <span style="position: absolute; top: 45%; left: 25%; color: green; font-weight: bold; background-color: aqua;">
                            <?php
                        ...
                        <span style="position: absolute; top: 50%; left: 5%; color: green; font-weight: bold; background-color: aqua;">
                            <?php
                        ...
                        <span style="position: absolute; top: 50%; left: 25%; color: green; font-weight: bold; background-color: aqua;">
                            <?php
                        ...
                        <span style="position: absolute; top: 58%; left: 5%; color: green; font-weight: bold; background-color: aqua;">
                            <?php
                        ...
                        <span style="position: absolute; top: 58%; left: 25%; color: green; font-weight: bold; background-color: aqua;">
                            <?php
                        ...
                        <span style="position: absolute; top: 60%; left: 5%; color: purple; font-weight: bold; background-color: aqua;">
                            <?php
                        ...
                        <span style="position: absolute; top: 60%; left: 25%; color: purple; font-weight: bold; background-color: aqua;">
                            <?php
                        ...
                        <!-- Posterior -->
                        <span style="position: absolute; top: 7%; left: 78%; color: red; font-weight: bold; background-color: aqua;">
                            <?php
                        ...
                        <span style="position: absolute; top: 11%; left: 78%; color: red; font-weight: bold; background-color: aqua;">
                            <?php
                        ...
                        <span style="position: absolute; top: 13%; left: 65%; color: red; font-weight: bold; background-color: aqua;">
                            <?php
                        ...
                        <span style="position: absolute; top: 13%; left: 85%; color: red; font-weight: bold; background-color: aqua;">
                            <?php
                        ...
                        <span style="position: absolute; top: 20%; left: 65%; color: green; font-weight: bold; background-color: aqua;">
                            <?php
                        ...
                        <span style="position: absolute; top: 20%; left: 93%; color: green; font-weight: bold; background-color: aqua;">
                            <?php
                        ...
                        <span style="position: absolute; top: 24%; left: 65%; color: green; font-weight: bold; background-color: aqua;">
                            <?php
                        ...
                        <span style="position: absolute; top: 24%; left: 93%; color: green; font-weight: bold; background-color: aqua;">
                            <?php
                        ...
                        <span style="position: absolute; top: 28%; left: 65%; color: green; font-weight: bold; background-color: aqua;">
                            <?php
                        ...
                        <span style="position: absolute; top: 28%; left: 93%; color: green; font-weight: bold; background-color: aqua;">
                            <?php
                        ...
                        <span style="position: absolute; top: 15%; left: 78%; color: green; font-weight: bold; background-color: aqua;">
                            <?php
                        ...
                        <span style="position: absolute; top: 20%; left: 78%; color: green; font-weight: bold; background-color: aqua;">
                            <?php
                        ...
                        <span style="position: absolute; top: 27%; left: 78%; color: green; font-weight: bold; background-color: aqua;">
                            <?php
                        ...
                        <span style="position: absolute; top: 32%; left: 75%; color: green; font-weight: bold; background-color: aqua;">
                            <?php
                        ...
                        <span style="position: absolute; top: 32%; left: 85%; color: green; font-weight: bold; background-color: aqua;">
                            <?php
                        ...
                        <span style="position: absolute; top: 37%; left: 75%; color: green; font-weight: bold; background-color: aqua;">
                            <?php
                        ...
                        <span style="position: absolute; top: 37%; left: 85%; color: green; font-weight: bold; background-color: aqua;">
                            <?php
                        ...
                        <span style="position: absolute; top: 45%; left: 75%; color: green; font-weight: bold; background-color: aqua;">
                            <?php
                        ...
                        <span style="position: absolute; top: 45%; left: 85%; color: green; font-weight: bold; background-color: aqua;">
                            <?php
                        ...
                        <span style="position: absolute; top: 50%; left: 75%; color: green; font-weight: bold; background-color: aqua;">
                            <?php
                        ...
                        <span style="position: absolute; top: 50%; left: 85%; color: green; font-weight: bold; background-color: aqua;">
                            <?php
                        ...
                        <span style="position: absolute; top: 58%; left: 75%; color: green; font-weight: bold; background-color: aqua;">
                            <?php
                        ...
                        <span style="position: absolute; top: 58%; left: 85%; color: green; font-weight: bold; background-color: aqua;">
                            <?php
                        ...
                        <span style="position: absolute; top: 60%; left: 75%; color: purple; font-weight: bold; background-color: aqua;">
                            <?php
                        ...
                        <span style="position: absolute; top: 60%; left: 85%; color: purple; font-weight: bold; background-color: aqua;">
                            <?php
                        ...
                        <!-- Lateral -->
                        <span style="position: absolute; top: 7%; left: 48%; color: red; font-weight: bold; background-color: aqua;">
                            <?php
                        ...
                        <span style="position: absolute; top: 11%; left: 48%; color: red; font-weight: bold; background-color: aqua;">
                            <?php
                        ...
                        <span style="position: absolute; top: 14%; left: 48%; color: red; font-weight: bold; background-color: aqua;">
                            <?php
                        ...
                        <span style="position: absolute; top: 16%; left: 53%; color: green; font-weight: bold; background-color: aqua;">
                            <?php
                        ...
                        <span style="position: absolute; top: 20%; left: 48%; color: green; font-weight: bold; background-color: aqua;">
                            <?php
                        ...
                        <span style="position: absolute; top: 24%; left: 48%; color: green; font-weight: bold; background-color: aqua;">
                            <?php
                        ...
                        <span style="position: absolute; top: 28%; left: 48%; color: green; font-weight: bold; background-color: aqua;">
                            <?php
                        ...
                        <span style="position: absolute; top: 37%; left: 45%; color: green; font-weight: bold; background-color: aqua;">
                            <?php
                        ...
                        <span style="position: absolute; top: 45%; left: 48%; color: green; font-weight: bold; background-color: aqua;">
                            <?php
                        ...
                        <span style="position: absolute; top: 50%; left: 48%; color: green; font-weight: bold; background-color: aqua;">
                            <?php
                        ...
                        <span style="position: absolute; top: 58%; left: 48%; color: green; font-weight: bold; background-color: aqua;">
                            <?php
                        ...
                        <span style="position: absolute; top: 60%; left: 48%; color: purple; font-weight: bold; background-color: aqua;">
                            <?php
