...
<br>
<br>
<!-- <p style="position:absolute;top:2px;left:548px;white-space:nowrap" class="ft00">Muestra: <strong style="font-size: 11px"><?php echo $body[0]->resultado ?></strong> </p> -->
<table style="width: 100%;font-size: 13.4px">
    <tr style="background-color: darkgrey;">
        <td style="font-size: 14px; padding: 6px;"><strong style="font-size: 14px; ">Prueba</strong></td>
        <td style="font-size: 14px; padding: 6px; text-align:center;"><strong style="font-size: 14px; ">Resultado</strong></td>
        <td style="font-size: 14px; padding: 6px; text-align:center;"><strong style="font-size: 14px; ">Valor de Normalidad</strong></td>
    </tr>
    <tr>
    ...
    ?>
            <tr>
                ...
                <td class="italic" style="font-size: 14px; text-align:center;"><?php
                                                                                if ($value->resultado == 'DETECTADO') {
                                                                                    echo "<span style='font-weight:bold'>$value->resultado</span>";
                                                                                } else {
                                                                                    echo $value->resultado;
                                                                                }
                                                                                ?></td>
                <td class="italic" style="font-size: 14px; text-align:center;">NO DETECTADO</td>
            </tr>
    <?php
        }
    }
