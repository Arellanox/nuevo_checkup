...
<table style="width: 100%;font-size: 13.4px">
    ...
    <tr>
        <td style="font-size: 16.4px"><strong>PCR Detección Mycobacterium tuberculosis</strong></td>
        <td></td>
        <td></td>
    </tr>
    <tr>
    ...
    $body = array_slice($body, 0, count($body));
...
<br>
<p style="text-align:justify;"><strong>Método: </strong> PCR Tiempo Real<br>
    <strong>Tipo de muestra: </strong>Expectoración, Lavado bronquial, Orina <br>
    Líquidos orgánicos sin hemolisis, Sangre/EDTA, Biopsia, Bloques de parafina <br>
</p>
<br>