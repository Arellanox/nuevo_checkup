    ...
    <tbody>
        ...
        <tr class="col-foot-two">
            ...
            <td colspan="2" style="text-align: left;">
                <?php if (isset($encode_firma)) echo "<img style='position:absolute; right:50px; margin-top: -15px ' src='data:image/png;base64, " . $encode_firma . "' height='80px'> " ?>
            </td>
        </tr>
        <tr class="col-foot-three" style="font-size: 13px;">
            <td colspan="6" style="text-align: center; width: 50%; height: 110px;" id="qr">
