...
<div class="body-certificado">
    ...
    <div class="hallazgos" style="margin-top: 30px;">
        ...
        <div class="body">
            <div class="informacion-paciente">
                <p class="justify"> Femenino de 36 años de edad, madre viva aparentemente sana, su padre falleció por
            ...
            <div class="signos-vitales">
                <p class="justify">
                    Signos vitales: T.A. 105/73mmHg, FC 69x’, FR 17x´, Temp. 35.7ºC, SpO2: 99%
                </p>
            </div>
            <div class="exploracion-fisica">
                <p class="justify">
                    A la exploración física, presentó un peso de 62.2kg, talla 158cm, IMC: 26.52kg/m2,
    ...
    <div class="resultados">
        ...
        <table>
            ...
            <tr>
                <td class="res" colspan="4">IDx: Miopía</td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="res" colspan="4">IDX: Espirometría normal.</td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="res left" colspan="4">
                    - Prueba de esfuerzo máxima por FC y por consumo de oxígeno, negativa para isquemia miocárdica.
            ...
            <tr>
                <td class="res left" colspan="4">
                    - Estudio de tórax de aspecto normal.
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="res left" colspan="4">
                    - Ultrasonido abdominal dentro de los parámetros normales.
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="res left" colspan="4">
                    - Ultrasonido doppler dentro de los parámetros normales.
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="res left" colspan="4">
                    - Adenopatías inflamatorias en región axilar derecha.
                    <br>
                    - Categoría Birads 2
                </td>
            </tr>
            ...
            <tr>
                <td class="res" colspan="4">
                    Extendido citológico sin alteraciones en la diferenciación celular
                </td>
            </tr>
        </table>
        ...
        <table style="margin-top: 20px;">
            ...
            <tr>
                ...
                <td class="res justify">
                    Glucosa 85mg/dl, Urea 37mg/dl, Bun 19.02mg/dl, Creatinina sérica 0.78
            ...
            <tr>
                ...
                <td class="res justify">
                    T3 total normal,T3 libre normal, T4 total normal, T4 libre normal, TSH 4.94
                    uUI/mL.
                </td>
            </tr>
            <tr>
    ...
    <div class="conclusion">
        ...
        <table>
            ...
            <tr>
                <td class="left">
                    1. Acudir al servicio de Fisioterapia y Rehabilitación.
                    <br>
