...
<head>
    ...
    <?php include 'includes/styles/certificado_bimo.php' ?>
    <style>
        .footer .page:after {
...
<body>
    ...
    <header class="header">
        ...
        include 'includes/headers/header_certificado_bimo.php';
        ?>
    </header>
    ...
    <footer class="footer">
        <?php include 'includes/footer/footer_certificado_bimo.php'; ?>
    </footer>
</body>
