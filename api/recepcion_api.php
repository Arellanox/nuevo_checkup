...
switch ($api) {
    ...
    case 2:
        ...
        #
        $response = $master->getByNext('sp_recepcion_cambiar_estado_paciente', array($idTurno, $estado_paciente, $comentarioRechazo, $alergias, $e_diagnostico, null, $medico_tratante_id, $_SESSION['id'],$vendedor_id, $proveedor_id)); #<-- la id de segmento manda error si no se le envia algo
