...
switch ($api) {
    ...
    case 2:
        ...
        if ($estado_paciente == 1) {
            ...
            $response = $master->insertByProcedure('sp_recepcion_detalle_paciente_g', array($idTurno, $idPaquete, null, 1));
        ...
        if (is_array($servicios)) {
            if (count($servicios) > 0) {
                ...
                foreach ($servicios as $key => $value) {
                    // print_r($servicios);
                    $response2 = $master->insertByProcedure('sp_recepcion_detalle_paciente_g', array($idTurno, null, $value, 1));
                }
            }
        }
