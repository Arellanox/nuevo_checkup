      ...
      <div class="modal-body">
        ...
        <form class="row" id="formEditarPaciente">
          ...
          <div class="col-6 col-lg-3">
            ...
            <input type="date" class="form-control input-form" name="nacimiento" placeholder="" required id="editar-nacimiento" onchange="$(`#editar-edad`).val(calcularEdad2(this.value)['numero'])
                                                $(`#span_formEdad_edit`).html(calcularEdad2(this.value)['tipo'])">
          </div>
          <div class="col-6 col-lg-2">
            <label for="edad" class="form-label">Edad</label>
            <div class="input-group">
              <input type="number" class="form-control input-form" disabled step="0.01" name="edad" placeholder="" min="0" max="150" required id="editar-edad">
