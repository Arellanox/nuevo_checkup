...
$menu == 'Laboratorio Biomolecular'
    ...
    <div class="row">
        <div class="col-auto d-flex gap-3 align-items-center">
            <button type="button" class="btn btn-primary position-relative gap-2" id="btn-maquilas-pendientes-notificacion"
                    data-bs-toggle="tooltip" data-bs-placement="bottom" title="Estudio envido a mquilar por aprobar"
            >
                <i class="fa fa-clock-o"></i> Maquilas
                <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger">
                      <span id="maquilas-pendientes-notificacion">...</span>
                      <span class="visually-hidden">maquilas pendientes</span>
                    </span>
            </button>
            <button type="button" class="btn btn-primary position-relative gap-2" id="btn-estudios-pendientes-notificacion"
                    data-bs-toggle="tooltip" data-bs-placement="bottom" title="Estudios pendientes por realizar"
            >
