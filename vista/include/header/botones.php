...
<?php
$condicion = $menu == "Estudios - Laboratorio" || $menu == "Estudios" || $menu == "Grupos de estudios - Laboratorio" ||
    $menu == "Grupos de estudios" ||  $menu == "Estudios de Rayos X" || $menu == 'Estudios de Ultrasonido' ||
    $menu == "Estudios Checkup";

if ($menu == "Estudios - Laboratorio" || $menu == "Estudios" || $menu == "Grupos de estudios - Laboratorio" ||
    $menu == "Grupos de estudios" ||  $menu == "Estudios de Rayos X" || $menu == 'Estudios de Ultrasonido' ||
    $menu == "Estudios Checkup") :
?>
...
<?php if (
    $menu == 'Reportes de Laboratorio Clínico' || $menu == 'Validación de resultados de laboratorio' ||
    $menu == 'Laboratorio Clínico' || $menu == 'Resultados de Laboratorio Clinico' ||
    $menu == 'Resultados de Laboratorio Biomolecular' || $menu == 'Laboratorio Biomolecular') :
?>
    <div class="row">
...
<?php if ($menu == 'Resultados de Ultrasonido' || $menu == 'Carga de imagenes de Ultrasonido'
    || $menu == 'Resultados de Rayos X' || $menu == 'Carga de placas de Rayos X' || $menu == 'Resultados de Espirometría'
    || $menu == 'Resultados de Audiometría' || $menu == 'Resultados de Oftalmología' || $menu == 'Resultados de Electrocardiograma'
    || $menu == 'Carga de Electrocardiograma' || $menu == 'Toma de muestras' || $menu == 'Somatometría | Signos Vitales'
    || $menu == 'Consultorio' || $menu == 'Estudio de Composición Corporal (InBody)' || $menu == 'Toma de muestras Checkups'
