...
<?php if ($menu == "Recepción | Espera" || $menu == "Recepción | Ingresados" || $menu == "Recepción | Rechazados") : ?>
  ...
  <button type="button" class="btn btn-hover me-2" style="margin-bottom:4px" data-bs-toggle="modal" data-bs-target="#ModalRegistrarPaciente" data-bs-dismiss="offcanvas">
    <i class="bi bi-person-plus"></i> Registrar
  </button>

  <button type="button" class="btn btn-hover me-2" style="margin-bottom:4px" data-bs-toggle="modal" data-bs-target="#ModalRegistrarPrueba" data-bs-dismiss="offcanvas">
    <i class="bi bi-person-lines-fill"></i> Agendar
  </button>


  <button type="button" class="btn btn-hover me-2" data-bs-toggle="modal" data-bs-target="#modalSolicitudIngresoParticulares" data-bs-dismiss="offcanvas">
