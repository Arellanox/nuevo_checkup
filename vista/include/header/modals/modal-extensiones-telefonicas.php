<ul class="dropdown-menu bg-navbar-drop dropdown-menu-bottom dropdown-menu-lg-start" aria-labelledby="dropExtTelefonos"
    ...
    <table class="table radiuszero" style="margin-bottom: 0px;">
        ...
        <tr>
            <th scope="row">Lab. Biomolecular</th>
            <td>1011</td>
        </tr>
        <tr>
