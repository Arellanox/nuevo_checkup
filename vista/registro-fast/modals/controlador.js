$.post("modals/registro.php", function (html) {
  ...
  $.getScript(http + servidor + "/nuevo_checkup/vista/include/modal-fast/js/registrar-paciente.js");
  // Script de pruebas
  $.getScript(http + servidor + "/nuevo_checkup/vista/include/modal-fast/js/registrar-agenda.js");
