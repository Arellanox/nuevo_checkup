tablaPrincipal = $('#tablaPrincipal').DataTable({
  ...
  columnDefs: [
    ...
    { target: 4, className: '', title: "Servicio" },
    { target: 5, className: '', title: "Área" },
    { target: 6, className: 'none', title: "AÑO" },
    { target: 7, className: 'none', title: "MES" },
    { target: 8, className: 'none', title: "DíA" },
  ],
  dom: 'Bfrtip',
  buttons: [
    {
