...
<div class="row overflow-auto">
  ...
  <div class="col-12 col-xl-3 tab-second overflow-auto" id="tab-informacion" style="margin-right: -5px !important;  display:none !important;max-height: 90vh;">
  ...
  <div class="col-12 col-xl-5 tab-second" id="tab-reporte" style="margin-right: -5px !important;  display:none !important">
    <div class="rounded p-3 shadow my-2">
      <div class="row">
        <div class="col-12">
          <h4>Pacientes</h4>
          <p class="none-p">Lista de pacientes atendidos y enviados</p>
