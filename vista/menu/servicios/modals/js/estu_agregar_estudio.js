...
select2(".medidasExamenes", "ModalRegistrarServicio")
select2(".conceptoFactu", "ModalRegistrarServicio")
select2(".metodoExamenes", "ModalRegistrarServicio")
select2(".clasificacionExamenes", "ModalRegistrarServicio")
