                    ...
                    <div class="panel-step-2 row hidden">
                        ...
                        <div class="row">
                            <div class="col-6">
                                ...
                                <a href="#" id="visualizar_pdf_situacion_fiscal" target="_blank" class="d-block py-4 text-center hidden">
                                    <i class="bi bi-file-earmark-pdf"></i>
                                    Visualizar PDF de Situación Fiscal
                                </a>
                                <input type="file" name="pdf_situacion_fiscal[]" accept="application/pdf" id="pdf_situacion_fiscal"
                                       class="form-control input-form">
                            </div>
                            <div class="col-6">
                                <label for="pdf_convenios" class="form-label">PDF Convenio</label>
                                <a href="#" id="visualizar_pdf_convenios" target="_blank" class="d-block py-4 text-center hidden">
                                    <i class="bi bi-file-earmark-pdf"></i>
                            ...
                            <div class="col-6">
                                ...
                                <a href="#" id="visualizar_pdf_lista_precios" target="_blank" class="d-block py-4 text-center hidden">
                                    <i class="bi bi-file-earmark-pdf"></i>
                                    Visualizar PDF de Lista de Precios
                                </a>
                                <input type="file" name="pdf_lista_precio[]" accept="application/pdf" id="pdf_lista_precios"
                                       class="form-control input-form">
                            </div>
                        </div>
                    </div>
