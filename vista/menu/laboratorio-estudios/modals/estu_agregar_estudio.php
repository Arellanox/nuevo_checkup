                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        ...
                                        <input type="text" name="abreviatura" class="form-control input-form"
                                               id="input-abreviatura" data-bs-toggle="tooltip" data-bs-placement="top"
                                               title="Abreviatura que se visualizará en etiquetas si es necesario"
                                    ...
                                    <div class="col-12 col-md-12">
                                        ...
                                        <select name="clasificacion_id" class="input-form"
                                                id="registrar-clasificacion-estudio" required>
                                        </select>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" value=""
                                                   id="sin_clasificacion">
                                    ...
                                    <div class="row" style="zoom:100%;">
                                        ...
                                        <div class="col-3">
                                            <input type="radio" name="local" id="registrar-subrogaSi" value="0"
                                                   required>
                                            <label for="registrar-subrogaSi">Si</label>
                                        </div>
                                        <div class="col-3">
                                            <input type="radio" name="local" id="registrar-subrogaNo" value="1"
                                                   required>
                            ...
                            <div class="rounded p-3 shadow my-2">
                                <div class="row">
                                    ...
                                    <div class="" id="div-select-grupo">
                                        <div class="row">
                                            <div class="col-12 col-lg-12 col-xxl-6">
                                                ...
                                                <select name="grupo_examen[0][grupo_id]"
                                                        class="input-form select-contenedor-Grupo" required=""></select>
                                            </div>
                                            <div class="col-12 col-lg-8 col-xxl-4">
                                                <label for="grupo_examen[0][orden]" class="form-label">Posicion del
                                                    grupo</label>
                                                <input type="text" placerholder="Orden del servicio para el grupo"
                                                       name="grupo_examen[0][orden]" required value=""
                                                       class="form-control input-form">
                                            </div>
                                            <div class="col-2 d-flex justify-content-start align-items-center">
                                                <button type="button" class="btn btn-hover eliminarContenerMuestra1"
                                                        data-bs-contenedor="2" style="margin-top: 20px;">
                                    ...
                                    <div class="row mb-2" style="zoom:100%;">
                                        ...
                                        <div class="col-3">
                                            <input type="radio" name="grupos" id="registrar-grupoEstudio" value="0"
                                                   required>
                                            <label for="registrar-grupoEstudio">Estudio</label>
                                        </div>
                                        <div class="col-3">
                                            <input type="radio" name="grupos" id="registrar-grupoGrupo" value="1"
                                                   required>
                                    ...
                                    <div class="" id="div-select-metodo">
                                        <div class="row">
                                            <div class="col-10 col-md-10"><label for="Método[0]"
                                                                                 class="form-label select-contenedor">Método</label>
                                    ...
                                    <div class="" id="div-select-contenedores">
                                        <div class="row">
                                            <div class="col-5 col-md-5">
                                                ...
                                                <select name="contenedores[2][contenedor]"
                                                        id="registrar-contenedor2-estudio" class="input-form"
                                                        required="">
                                            ...
                                            <div class="col-5 col-md-5">
                                                <label for="contenedores[2]" class="form-label select-contenedor">Tipo o
                                                    muestra</label>
                                                <select name="contenedores[2][muestra]"
                                                        id="registrar-muestraCont2-estudio" class="input-form"
                                                        required="" placeholder="Seleccione un contenedor">
                                            ...
                                            <div class="col-2 d-flex justify-content-start align-items-center">
                                                <button type="button" class="btn btn-hover eliminarContenerMuestra1"
                                                        data-bs-contenedor="2" style="margin-top: 20px;"><i
                        ...
                        <div class="col-12 col-lg-6 col-xl-4">
                            <div class="rounded p-3 shadow my-2">
                                ...
                                <div class="row" style="zoom:100%;">
                                    ...
                                    <div class="col-3">
                                        <input type="radio" name="muestra_valores" id="registrar-varepoSi" value="1"
                                               checked required>
                                        <label for="registrar-varepoSi">Si</label>
                                    </div>
                                    <div class="col-3">
                                        <input type="radio" name="muestra_valores" id="registrar-varepoNo" value="0"
                                               required>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <textarea name="valor_minimo" class="input-form" rows="2" cols="20"
                                                  id="valor_minimo_referencia"></textarea>
                                    </div>
                                    <div class="col-12">
                                        <label for="valor_maximo" class="form-label">Valor maximo</label>
                                        <textarea name="valor_maximo" class="input-form" rows="2" cols="20"
                                                  id="valor_maximo_referencia"></textarea>
                                    </div>
                                    <div class="col-4">
                                        <label for="sexo_enum" class="form-label select-contenedor">Dirigido a:</label>
                                        <select name="sexo_enum" class="input-form" required=""
                                                id="input-dirigido-sexo-referencia">
