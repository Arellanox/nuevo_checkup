                ...
                <form class="" id="formEditarGrupo">
                    ...
                    <div class="row">
                        <div class="col-4">
                            ...
                            <input type="text" name="nombre_estudio" id="edit-nombre-grupo"
                                   class="form-control input-form" required>
                        </div>
                        <div class="col-2">
                            <label for="cve_estudio" class="form-label">CVE</label>
                            <input type="text" name="cve_estudio" id="edit-cve-grupo" class="form-control input-form"
                                   required>
                        </div>
                        ...
                        <div class="col-3 col-md-3">
                            ...
                            <input type="number" name="entrega" class="input-form" value="" id="edit-dias-grupo"
                                   required>
                        </div>
                        <div class="col-6 col-md-6">
                        ...
                        <div class="col-6 col-md-6">
                            ...
                            <br/>
                            <textarea class="md-textarea input-form" id="edit-indicaciones-grupo" name="indicaciones"
                                      cols="45" rows="2" placeholder=""></textarea>
                        </div>
