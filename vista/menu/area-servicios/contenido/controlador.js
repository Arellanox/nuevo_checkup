  ...
  switch (hash) {
    case "Estudios":
      if (validarVista('SERVICIOS (ESTUDIOS)')){
        dataAjaxTabla = {api: 2, area_id: areaActual}
        obtenerContenidoEstudios("Estudios - "+tituloPorArea(areaActual));
      }
      break;
    case "Grupos":
      if (validarVista('SERVICIOS (GRUPOS)')){
        dataAjaxTabla = {api: 2}
        obtenerContenidoGrupos("Grupos - "+tituloPorArea(areaActual));
      }
      break;
    // case "Equipos":
...
function tituloPorArea(id){
  alert(id);
  switch (id) {
    case 3: return "Oftalmología"; break;
    case 4: return "Audometría"; break;
    case 5: return "Espirometría"; break;
    case 7: return "Ultra Sonido"; break;
    case 7: return "Rayos X"; break;
    default:
      break;
  }
}
