<div class="modal fade" id="modalAsignarFirma" tabindex="-1" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-md modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="filtrador">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" style="width: 25px; fill: rgb(000, 078, 089)">
                    ...
                    Asignar Firma Médica
                </h5>
            </div>
            <div class="modal-body">
                <div>
                    <label class="form-label">Doctor Responsabe</label>
                    <p>Selecciona el médico que firmará este estudio en el reporte.</p>
            ...
            <div class="modal-footer">
                ...
                <button id="btn_confirmar_asignacion_firma" type="button" class="btn btn-confirmar">
