                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-4">
                                <div class="document-item">
                                    ...
                                    <input type="file" class="form-control" name="doc_curp" accept=".pdf,.doc,.docx" required>
                                    <div class="invalid-feedback">
...
// Reestablecer la signature pad al enviar el formulario
        document.getElementById('postulacionForm').addEventListener('reset', function() {
            if (signaturePad) {
                signaturePad.clear();
                document.getElementById('firmaDigitalInput').value = '';
                updateSignatureStatus('Firma no capturada', 'warning');
            }
        });
    </script>
</body>
