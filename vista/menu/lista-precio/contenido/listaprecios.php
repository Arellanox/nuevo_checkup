    ...
    <div class="card col-4 p-4" style="margin-bottom:5px;">
        <div class="text-start row" id="text-start" style="margin-top:4px;zoom:95%;margin-bottom:5px;">
            ...
            <div class="d-flex justify-content-center">
                <?php if (filter_var($_POST['franquicia'], FILTER_VALIDATE_BOOLEAN) === false): ?>
                    <div class="col-auto m-1">
                        <input type="radio" class="btn-check" name="selectTipLista" title="Costo" id="check-Costo"
                               value="1" autocomplete="off" checked>
                        <label class="btn btn-outline-primary" for="check-Costo"><i class="bi bi-list"></i>
                            Costo</label>
                    </div>
                <?php endif; ?>
                <div class="col-auto m-1">
                    <input type="radio" class="btn-check" name="selectTipLista" title="Precios" id="check-Precios"
                           value="2" autocomplete="off">
                    <label class="btn btn-outline-primary" for="check-Precios"><i class="bi bi-list"></i>
                        Precios</label>
                </div>
                <div class="col-auto m-1">
                    <input type="radio" class="btn-check" name="selectTipLista" title="Paquetes" id="check-paquetes"
                           value="3" autocomplete="off">
                    <label class="btn btn-outline-primary" for="check-paquetes"><i class="bi bi-list"></i>
                        Paquetes</label>
                </div>
            </div>
            ...
            <div class="col-auto m-1 vista_estudios-precios">
                <input type="radio" class="btn-check" name="selectChecko" title="Ultrasonido" id="check-img" value="11"
                       autocomplete="off">
                <label class="btn btn-outline-success" for="check-img"><i class="bi bi-list"></i> Ultrasonido</label>
            </div>
            <div class="col-auto m-1 vista_estudios-precios">
                <input type="radio" class="btn-check" name="selectChecko" title="Rayos X" id="check-rx" value="8"
                       autocomplete="off">
                <label class="btn btn-outline-success" for="check-rx"><i class="bi bi-list"></i> Rayos X</label>
            </div>
            <div class="col-auto m-1 vista_estudios-precios">
                <input type="radio" class="btn-check" name="selectChecko" title="Laboratorio" id="check-lab" value="6"
                       autocomplete="off">
                <label class="btn btn-outline-success" for="check-lab"><i class="bi bi-list"></i> Laboratorio</label>
            </div>
            <div class="col-auto m-1 vista_estudios-precios">
                <input type="radio" class="btn-check" name="selectChecko" title="Otros Servicios" id="check-otros"
        ...
        <div class="text-center" style="margin-top:4px; margin-bottom:5px;">
            <?php if (filter_var($_POST['franquicia'], FILTER_VALIDATE_BOOLEAN) === false): ?>
                ...
                <span data-bs-toggle="tooltip" data-bs-placement="top"
                      title="Selecciona una opción de lista a mostrar...">
            <button type="button" class="btn btn-hover me-2" style="margin-bottom:4px" id="vistaPreviaExel"
                    data-bs-toggle="modal" disabled data-bs-target="#vistaPreviaExelModal">
