            ...
            <div class="col-12">
                ...
                <div class="p-3" id="form-select-paquetes">
                    ...
                    <div class="row d-flex justify-content-center" style="margin-bottom: 15px">
                        <div class="col-auto">
                            <button class="btn btn-sm btn-confirmar" type="button" id="UsarPaquete"><i
                                        class="bi bi-binoculars"></i> Usar
                            </button>
                        </div>
                        <div class="col-auto">
                            <button class="btn btn-sm btn-borrar" type="button" id="CambiarPaquete"
                                    data-bs-toggle="tooltip" data-bs-placement="top" title="Borrará todo la tabla"><i
                                        class="bi bi-eraser"></i> Cambiar
                            </button>
                        </div>
                        <div class="col-auto">
                            <button class="btn btn-sm btn-info" type="button" id="asignarPaquete"
                                    data-bs-toggle="tooltip" data-bs-placement="top"
                                    title="Asignar el paquete seleccionado a los clientes correspondientes">
                                <i class="bi bi-pin-angle-fill"> </i>Asignar
                            </button>
                        </div>
                        <div class="col-auto">
                            <button class="btn btn-sm btn-secondary" type="button" id="editarInfoPaqueteBtn"
                                    data-bs-toggle="tooltip" data-bs-placement="top"
                                    title="Editar la información del paquete">
                    ...
                    <div class="row formContenidoPaquete" id="formPaqueteSelectEstudio">
                        ...
                        <div class="col-12 d-flex align-items-center d-flex justify-content-center">
                            <button type="submit" form="formCompletarPaquete" class="btn btn-confirmar m-1"
