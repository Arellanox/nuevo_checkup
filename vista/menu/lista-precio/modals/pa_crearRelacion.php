    ...
    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header header-modal">
                <h5 class="modal-title" class="titlePaqueteAsignado"><strong><span class="titlePaqueteAsignado">Relacion</strong>
                </h5>
                    ...
                    <div class="col-auto">
                        <div class="input-group mb-3">
                            <div class="input-group-text">
                                <label class="d-flex justify-content-center" for="">UNIVERSIDAD JUAREZ AUTOMONA DE
                                    TABASCO</label>
