        ...
        <form class="" id="formEditarPaquete">
          ...
          <div class="row">
            <div class="col-12">
              ...
              <input type="text" name="descripcion" class="form-control input-form" id="nombrePaqEditar" required>
            </div>
            <div class="col-12">
              <label for="tipo_paquete" class="form-label">Tipo de Paquete</label>
              <input type="text" name="tipo_paquete" class="form-control input-form" id="tipoPaqEditar" required>
            </div>
          </div>
        </form>
      </div>
