$(document).on("click", '#LibererDiaTemperatura', function (e) {
    e.preventDefault();
...
$("#liberarDiaTemperaturaForm").on("submit", function (e) {
    ...
    alertMensajeConfirm({
        title: "¿Estas seguro de liberar el rango de días?",
        text: "Ya no podrás revertir está acción",
        icon: "info"
    }, function () {
        ...
        if (fechaInicio > fechaFinal) {
            ...
            ajaxAwaitFormData({
                ...
                alertTemperatura("Rango de días liberado");
