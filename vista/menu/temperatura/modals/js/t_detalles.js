...
tablaTemperatura = $('#TablaTemperatura').DataTable({
    ...
    columns: [
        ...
        {//Día de captura
            data: 'FECHA_REGISTRO', render: function (data) {
                return formatoFecha2(data, [2, 0, 0, 2, 0, 0, 0])
            }
        },
        {//Fecha de captura de temperatura
    ...
    columnDefs: [
        ...
        { target: 1, title: 'Enfriador', className: 'none' },
        { target: 2, title: 'Termómetro', className: 'desktop' },
        { target: 3, title: 'Día', className: 'all' },
        { target: 4, title: 'Captura', className: 'min-tablet' },
        { target: 5, title: 'Turno', className: 'all' },
        { target: 6, title: 'Lectura', className: 'all' },
        { target: 7, title: 'Registrado', className: 'none' },
        { target: 8, title: 'Observaciones', className: 'none' },
        { target: 9, title: 'Observaciones del supervisor', className: 'none' },
        { target: 10, title: 'Fecha de registro', className: 'none' }
