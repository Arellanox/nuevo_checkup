                  ...
                  <div class="accordion-body">
                    <div class="row">
                      <div class="col-6">
                        <div class="row">
                          <div class="col-12">
                            <select class="" name="paquete" id="select-lab">
                            </select>
                          </div>
                          <div class="col-12">
                            <button type="submit" class="btn btn-confirmar" id="btn-obtenerID">
                  ...
                  <div class="accordion-body">
                    <div class="row">
                      <div class="col-6">
                        <div class="row">
                          <div class="col-12">
                            <select class="" name="paquete" id="select-rx">
                            </select>
                          </div>
                          <div class="col-12">
                            <button type="submit" class="btn btn-confirmar" id="btn-obtenerID">
                  ...
                  <div class="accordion-body">
                    <div class="row">
                      <div class="col-6">
                        <div class="row">
                          <div class="col-12">
                            <select class="" name="paquete" id="select-us">
                            </select>
                          </div>
                          <div class="col-12">
                            <button type="submit" class="btn btn-confirmar" id="btn-obtenerID">
                  ...
                  <div class="accordion-body">
                    <div class="row">
                      <div class="col-6">
                        <div class="row">
                          <div class="col-12">
                            <select class="" name="paquete" id="select-otros">
                            </select>
                          </div>
                          <div class="col-12">
                            <button type="submit" class="btn btn-confirmar" id="btn-obtenerID">
